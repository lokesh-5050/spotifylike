        ...
        <div className={`${module.left}`}>
          ...
          <div className={`${module.options}`}>
            ...
            <div className={`${module.main_logos} ${module.secOptions} `}>
              ...
              <div className={`${module.main_list} `}>
                <div className={`${module.box}`}>
                  <svg role="img" height="13" width="13" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 uPxdw"><path d="M3.75 0A1.75 1.75 0 002 1.75v12.952c0 1.051 1.22 1.633 2.037.972l3.962-3.208 3.943 3.204c.817.663 2.038.082 2.038-.97V1.75A1.75 1.75 0 0012.23 0H3.75z"></path></svg>
                </div>
                <h6>Your Libraray</h6>
              </div>
              ...
              <div className={`${module.install}`}>
                <svg role="img" height="24" width="24" fill='white' aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon" class="Svg-sc-ytk21e-0 uPxdw"><path d="M12 3a9 9 0 100 18 9 9 0 000-18zM1 12C1 5.925 5.925 1 12 1s11 4.925 11 11-4.925 11-11 11S1 18.075 1 12z"></path><path d="M12 6.05a1 1 0 011 1v7.486l1.793-1.793a1 1 0 111.414 1.414L12 18.364l-4.207-4.207a1 1 0 111.414-1.414L11 14.536V7.05a1 1 0 011-1z"></path></svg>
                <h6 style={{ color: "#fff" }}>Install App</h6>
              </div>
